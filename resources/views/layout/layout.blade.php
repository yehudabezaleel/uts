...
<html lang="en">
    <head>
        ...
        <title>Astronix Library &vert; @yield('title') </title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">@yield('subheader')</li>
                        </ol>
                            @yield('content')
                     </div>
                </main>
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-center small">
                            <div class="text-muted">Copyright &copy; astronixlibrary2021</Li></div>
                        </div>
                    </div>
                </footer> 
            </div>
